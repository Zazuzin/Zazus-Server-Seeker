...
- [x] Runtime configuration and server history excluded from source and artifacts
- [x] API keys excluded and `config/` ignored
- [x] Java 21 build and complete verification suite
- [x] Fabric metadata and dependency requirements validated
- [x] Privacy, security, support and contributing documentation
